...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function formTmplTemplate(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"public\u002Fapp\u002Fcomponents\u002FForm\u002Fform.tmpl.pug":"h2 #{header}\n\nform.login_form\n    each i in inputs\n        input(name = i.name, type = i.type, placeholder = i.placeholder, class = i.className, value = i.value, accept = i.accept)\n\n\n\n\n"};
;var locals_for_with = (locals || {});(function (header, inputs) {;pug_debug_line = 1;pug_debug_filename = "public\u002Fapp\u002Fcomponents\u002FForm\u002Fform.tmpl.pug";
pug_html = pug_html + "\u003Ch2\u003E";
;pug_debug_line = 1;pug_debug_filename = "public\u002Fapp\u002Fcomponents\u002FForm\u002Fform.tmpl.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = header) ? "" : pug_interp)) + "\u003C\u002Fh2\u003E";
;pug_debug_line = 3;pug_debug_filename = "public\u002Fapp\u002Fcomponents\u002FForm\u002Fform.tmpl.pug";
pug_html = pug_html + "\u003Cform class=\"login_form\"\u003E";
;pug_debug_line = 4;pug_debug_filename = "public\u002Fapp\u002Fcomponents\u002FForm\u002Fform.tmpl.pug";
// iterate inputs
;(function(){
  var $$obj = inputs;
...
;pug_debug_line = 5;pug_debug_filename = "public\u002Fapp\u002Fcomponents\u002FForm\u002Fform.tmpl.pug";
